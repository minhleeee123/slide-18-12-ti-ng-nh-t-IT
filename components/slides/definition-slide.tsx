...
export function DefinitionSlide({ slide }: DefinitionSlideProps) {
  ...
  return (
    <div className="relative space-y-10">
      ...
      <h2 className="text-5xl font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent mb-8">{slide.title}</h2>
      <p className="text-3xl text-foreground mb-8 relative">
